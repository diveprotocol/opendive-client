...
Only the latest release (`0.2.0-alpha.1+draft.01`) is currently supported. Security updates will be provided for all future stable releases (`>=1.0.0`).

| Version                | Supported          |
| ---------------------- | ------------------ |
| 0.2.0-alpha.1+draft.01 | :white_check_mark: |
| 0.1.1+draft.00         | :x:                |
| 0.1.1-beta.2+draft.00  | :x:                |
| 0.1.1-beta.1+draft.00  | :x:                |
