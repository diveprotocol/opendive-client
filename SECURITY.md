...
Only the latest alpha release (`0.1.0+draft.00`) is currently supported. Security updates will be provided for all future stable releases (`>=1.0.0`).

| Version                | Supported          |
| ---------------------- | ------------------ |
| 0.1.1-beta.2+draft.00  | :white_check_mark: |
